...
const FoodCard = ({
    ...
    return (
        <>
            {/* sm for wishlist */}
            {isWishlist && (
                <div className="flex items-center min-h-[100px] md:hidden border-t border-gray-200 first:border-t-0">
                    <div 
                        className="flex flex-row sm:flex-row w-full gap-4 py-4 items-center max-h-[88px]"
