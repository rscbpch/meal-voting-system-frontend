...
import { FiUser, FiRotateCw, FiLogOut, FiGlobe, FiHeart} from "react-icons/fi";
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div className="relative">
                                <button ref={dropdownRef} onClick={() => setShowUserDropdown((prev) => !prev)} className="cursor-pointer">
                                    <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.5 10C7.20186 10 6.90373 9.85492 6.75466 9.70985L1.8354 4.92228C1.3882 4.48705 1.3882 3.76166 1.8354 3.32642C2.28261 2.89119 3.02795 2.89119 3.47516 3.32642L7.5 7.24352L11.5248 3.32642C11.972 2.89119 12.7174 2.89119 13.1646 3.32642C13.6118 3.76166 13.6118 4.48705 13.1646 4.92228L8.39441 9.56477C8.09627 9.85492 7.79814 10 7.5 10Z" fill="#A5A5A5"/>
                                    </svg>
                                </button>
                                {showUserDropdown && (
